                                ...
                                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                                    <div class="px-4 pt-4 bg-white space-y-6 sm:p-6">
                                        <fieldset>
                                            ...
                                            <p class="text-sm text-gray-500">Para realizar la compra de su carrito tiene que
                                                seleccionar
                                        ...
                                        <fieldset>
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500">Puede marcar la siguiente opcion si desea
                                                    recibir sus
                                                    productos
                                                    en su vivienda, cabe resaltar que se agregara un cargo adicional a su
                                                    total de
                                                    productos.
                                                </p>
                                            </div>
                                            <div class="mt-4 space-y-4">
                                                <div class="flex items-start">
                                                    <div class="flex items-center h-5">
                                                        <input id="comments" name="comments" type="checkbox" value="confirm"
                                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded"
                                                            wire:click="confirmdelivery">
                                                    </div>
                                                    <div class="ml-3 text-sm">
                                                        <label for="comments" class="font-medium text-gray-700">Enviar a
                                                            domicilio</label>
                                                        <p class="text-gray-500">Se aumentara un precio adicional no mayor
                                                            a s/ 10
