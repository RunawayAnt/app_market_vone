 <div>
     ...
     <x-jet-dialog-modal wire:model="open" maxWitdh="sm">
         <x-slot name="title">
             <div class=" text-left">
                 <h3 class="text-lg font-medium leading-6 text-gray-900"> &nbsp;Informacion requerida para compras</h3>
                 <p class="ml-1 mt-2 text-sm text-gray-500">
                     Es necesario rellenar los siguientes datos para realizar compras den
                 </p>
             </div>
         </x-slot>
         ...
         <x-slot name="footer">
             ...
             <x-jet-button wire:click="saveData">
                 Guardar
             </x-jet-button>
         </x-slot>
     </x-jet-dialog-modal>
